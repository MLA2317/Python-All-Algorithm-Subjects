...
# 33 masala c ++ True
# Begin33. X kg konfet A som turadi. 1 kg va Y kg konfet qancha turishini aniqlovchi programma tuzilsin
...
# 34 masala c ++ True
# Begin34. X kg shkolad A som turadi va Y kg konfet B som turadi. 1 kg shloload 1 kg konfetdan qancha qimmat turushini aniqlovchi programa tuzilsin
...
# 35 masala c ++ True
# Begin35. Qayiqning tezligi V km/soat, daryo oqimining tezligi U km/soat, (V>U). Qayiqning daryo oqimi boyicha harakatlanish vaqti T1, oqimga qarshi T2 Qayiqni yurgan S yolini aniqlovchi programma tuzilsin
...
# 36 masala c++ True
# Begin36.  Birinchi avtomabining tezigi V1 km /soat ikkinchisiniki V2 km/ soat, ular orasidagi masofa S. Ular biri-biridan uzoqlasha boshlasa T vagtdan keyin ular orasidagi masofani aniglavdigan programma tuzilsin.
...
# 37 masala c++ True
# Begin37. Birinchi avtomabilning tezligi V1 km/soat, ikkinchisinikiV2, km/ soat,ular orasidagi masofa S. Ular biri-biri tomonga harakatlana boshlasa T vaqtdan keyin ular orasidagi masofani aniqlaydigan programma tuzilsin.
...
# 38 masala c++ True
# Begin38. A va B koeffisentlari berilgan, A * x + B = 0 chiziqli tenglamaning yechimini (x ni) aniqlaydigan programma tuzilsin. (1 = teng ema 0)
...
# 39 masala c++ False
# Begin39. A, B, C koeffisienti berilgan. Ax kvadrat + Bx + C = 0 kvadrat tenglamani diskriminanti noldan katta bo'lsa  uning yechimlarini aniqlaydigan programma tuzilsin (A= emsa 0). X1,2 = (-B +- ildizni ichida D)/2 * A, D = B kvadrat - 4 * A * C
...
# 40 masala c++
# Begin40. A1,B1,C1,A2,B2,C2 koeffisentlari berilgan, chiziqli tenglamalar sistemasi yechimlarini aniqlaydigan programma yechilsin
